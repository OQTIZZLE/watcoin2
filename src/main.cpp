...
uint256 hashGenesisBlock("0x00000ee5db2ff5aa2d6d09d61e62470f096dcd75e5ecfb046b0f3b0000800910");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // WatCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "WatCoin Signed Message:\n";
...
{
    // WatCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    {
       nSubsidy = 249999 * COIN;
       return nSubsidy + nFees;
    }
    
    else if (nHeight <= 299999)
    {
       nSubsidy = 124999 * COIN;
       return nSubsidy + nFees;
    }
    ...
    // old code
//    nSubsidy >>= (nHeight / 99999); // WatCoin: 99,999

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 4 * 60 * 60; // WatCoin: 4 hours
static const int64 nTargetSpacing = 99; // WatCoin: 99 seconds
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // WatCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
{
        static const int64 BlocksTargetSpacing = 99; // WatCoin: 99 seconds
        static const unsigned int TimeDaySeconds = 24 * 60 * 60; // WatCoin: 1 day
...
{
    // WatCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000ee5db2ff5aa2d6d09d61e62470f096dcd75e5ecfb046b0f3b0000800910");
    }
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "5/22/14";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 999 * COIN;
 ...
 if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x527efe2098166fc30bea94128cddeda640c0aac32812243a5a3c05e264a782ee"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // WatCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("WatCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("WatCoinMiner : ProcessBlock, block not accepted");
    }
